# Bank OCR Feature for Test Double

This repo contains Jess Rudder's solution for the Bank OCR Kata (originally defined [here](http://www.codingdojo.org/cgi-bin/wiki.pl?KataBankOCR)).  It reflects what she could implement in ~2 hours.  

## Approach

I wrote up the full set of user stories into issues on the repo.  When a story was completed, a PR was made for the associated issue.  The issue was closed out when the PR was merged in.
